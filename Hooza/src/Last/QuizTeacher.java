...
public class QuizTeacher extends javax.swing.JFrame implements Runnable {
    ...
    private void initComponents() {
        ...
        Editor.setBackground(new java.awt.Color(255, 204, 255));
        Editor.setFont(new java.awt.Font("MS Gothic", 0, 14)); // NOI18N
        Editor.setForeground(new java.awt.Color(255, 102, 255));
        ...
        CreateRoom.setBackground(new java.awt.Color(255, 204, 255));
        CreateRoom.setFont(new java.awt.Font("MS Gothic", 0, 14)); // NOI18N
        CreateRoom.setForeground(new java.awt.Color(102, 0, 102));
